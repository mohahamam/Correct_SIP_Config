...
def main():
	...
	print('Total Number of OLTs processed =', len(olts_processed))
	print('Total Number of OLTs scuessfully connected =', (len(olts_processed)-len([x for x in failedOLTs if x!=None])))
